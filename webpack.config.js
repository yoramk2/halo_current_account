...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'halo_current_account_service', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'halo_current_account_service', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ].concat(debug ? [] : [
