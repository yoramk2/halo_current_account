...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsBqReferenceIdMixin,AbsBaseLink):
