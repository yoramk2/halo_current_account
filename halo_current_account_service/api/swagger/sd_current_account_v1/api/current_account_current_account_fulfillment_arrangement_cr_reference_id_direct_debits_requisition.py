...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsRequisitionMixin,AbsBaseLink):
