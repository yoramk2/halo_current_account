...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensRequisitionMixin,AbsBaseLink):
