...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsBqReferenceIdRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsBqReferenceIdRequisitionMixin,AbsBaseLink):
