...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInterestsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInterestsBqReferenceIdMixin,AbsBaseLink):
