...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdFeesBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdFeesBqReferenceIdMixin,AbsBaseLink):
