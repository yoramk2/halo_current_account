...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStatementsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStatementsBqReferenceIdMixin,AbsBaseLink):
