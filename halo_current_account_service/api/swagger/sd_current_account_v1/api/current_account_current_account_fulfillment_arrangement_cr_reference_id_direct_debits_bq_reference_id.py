...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDirectDebitsBqReferenceIdMixin,AbsBaseLink):
