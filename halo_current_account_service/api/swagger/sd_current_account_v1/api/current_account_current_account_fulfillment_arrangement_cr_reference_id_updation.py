...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdUpdation(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdUpdationMixin,AbsBaseLink):

    def put(self, cr_reference_id):
        print(g.json)
