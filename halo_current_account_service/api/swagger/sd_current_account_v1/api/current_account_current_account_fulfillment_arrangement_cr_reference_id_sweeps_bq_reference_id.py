...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdSweepsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdSweepsBqReferenceIdMixin,AbsBaseLink):
