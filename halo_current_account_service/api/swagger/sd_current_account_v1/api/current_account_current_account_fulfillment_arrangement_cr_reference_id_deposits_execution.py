...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsExecution(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsExecutionMixin,AbsBaseLink):
