...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsBqReferenceIdExecution(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdDepositsBqReferenceIdExecutionMixin,AbsBaseLink):
