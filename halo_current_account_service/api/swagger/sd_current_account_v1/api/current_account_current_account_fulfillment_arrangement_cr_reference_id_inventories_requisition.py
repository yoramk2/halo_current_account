...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesRequisitionMixin,AbsBaseLink):
