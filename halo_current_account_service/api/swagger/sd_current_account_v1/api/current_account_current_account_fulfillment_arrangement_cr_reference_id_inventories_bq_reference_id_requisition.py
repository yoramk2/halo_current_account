...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesBqReferenceIdRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesBqReferenceIdRequisitionMixin,AbsBaseLink):
