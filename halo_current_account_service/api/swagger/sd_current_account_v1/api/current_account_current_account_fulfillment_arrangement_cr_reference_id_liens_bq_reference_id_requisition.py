...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensBqReferenceIdRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensBqReferenceIdRequisitionMixin,AbsBaseLink):
