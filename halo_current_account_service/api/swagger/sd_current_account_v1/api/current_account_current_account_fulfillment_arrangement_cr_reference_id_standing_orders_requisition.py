...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStandingOrdersRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStandingOrdersRequisitionMixin,AbsBaseLink):
