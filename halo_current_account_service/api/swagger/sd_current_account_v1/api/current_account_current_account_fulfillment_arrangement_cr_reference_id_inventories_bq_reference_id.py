...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdInventoriesBqReferenceIdMixin,AbsBaseLink):
