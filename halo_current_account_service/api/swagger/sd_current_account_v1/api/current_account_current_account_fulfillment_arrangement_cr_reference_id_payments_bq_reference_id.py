...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdPaymentsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdPaymentsBqReferenceIdMixin,AbsBaseLink):
