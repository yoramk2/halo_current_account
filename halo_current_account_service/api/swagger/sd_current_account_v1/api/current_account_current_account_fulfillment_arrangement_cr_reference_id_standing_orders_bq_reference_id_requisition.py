...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStandingOrdersBqReferenceIdRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdStandingOrdersBqReferenceIdRequisitionMixin,AbsBaseLink):
