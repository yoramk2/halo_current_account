...
class CurrentAccountCurrentAccountFulfillmentArrangementInitiation(Resource,CurrentAccountCurrentAccountFulfillmentArrangementInitiationMixin,AbsBaseLink):
