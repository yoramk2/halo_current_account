...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdLiensBqReferenceIdMixin,AbsBaseLink):
