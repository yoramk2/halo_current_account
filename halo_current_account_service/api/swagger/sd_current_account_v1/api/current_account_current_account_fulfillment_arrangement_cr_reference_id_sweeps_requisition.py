...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdSweepsRequisition(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdSweepsRequisitionMixin,AbsBaseLink):
