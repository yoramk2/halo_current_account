...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdRecording(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdRecordingMixin,AbsBaseLink):
