...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdReportsBqReferenceId(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdReportsBqReferenceIdMixin,AbsBaseLink):
