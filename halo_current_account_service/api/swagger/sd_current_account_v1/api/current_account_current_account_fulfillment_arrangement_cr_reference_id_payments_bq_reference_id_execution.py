...
class CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdPaymentsBqReferenceIdExecution(Resource,CurrentAccountCurrentAccountFulfillmentArrangementCrReferenceIdPaymentsBqReferenceIdExecutionMixin,AbsBaseLink):
